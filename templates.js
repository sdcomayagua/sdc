// templates.js
(() => {
  const mount = document.getElementById("templatesMount");
  if (!mount) return;
  ...
  <div class="modal" id="thanksModal" aria-hidden="true">
    <div class="sheet">
      <div class="head row" style="justify-content:space-between">
        ...
        <button class="btn" id="thanksClose">Cerrar</button>
      </div>
      <div class="body">
        <div class="thanksBox">
  ...
  <div class="modal" id="sortModal" aria-hidden="true">
    <div class="sheet">
      <div class="head row" style="justify-content:space-between">
        ...
        <button class="btn" id="sortClose">Cerrar</button>
      </div>
      <div class="body">
  ...
  <div class="modal" id="productModal" aria-hidden="true">
    <div class="sheet">
      <div class="head row" style="justify-content:space-between">
        ...
        <button class="btn" id="pmClose">Cerrar</button>
      </div>
      <div class="body">
        <div class="pmWrap">
          <div>
